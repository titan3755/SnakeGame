...
use boundary_collision_system::*;
use tail_movement_system::*;
use crate::components::CoordList;
...
fn main() {
    ...
    App::new()
        .insert_resource(CoordList::default())
        ...
        .add_system(boundary_collision_system)
        .run();
    // app -- app -- app -- app -- app -- app -- app -- app -- app -- app -- app -- app
}
